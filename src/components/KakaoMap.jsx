...
const KakaoMap = ({ location, path, readWalkPath = false }) => {
  ...
  const userPingImageSrc =
    "https://github.com/user-attachments/assets/22b5d010-662f-47c7-9213-3dbf69cb1360"
  const startFlagImageSrc =
    "https://github.com/user-attachments/assets/c918c7f8-9e17-4e1b-b3cf-1e701c01e767"
  ...
  useEffect(() => {
    ...
    loadKakaoMaps(readWalkPath ? historyWalkMap : initializeMap)
  }, [location.latitude, location.longitude, path, readWalkPath])
