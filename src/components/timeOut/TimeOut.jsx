...
function TimeOut() {
    ...
    return (
        <div className='timeset-wrap'>
            <h1>타임오버</h1>
            <br/>
            <p className='timeout-name'><span className='timeout-nickname'>{memberNickname}님은</span> 방금</p>
            <p className='timeout-time'>{`${minute<10 ? `0${minute}분`: `${minute}분`}${second<10 ? `0${second}초`: `${second}초`}`}
            <span className='timeout-save'> 절약했어요!</span> </p>
